...
public class Lunar {
    ...
    private static long[] termInfo =
            {0, 21208, 42467, 63836, 85337, 107014, 128867, 150921, 173149, 195551, 218072, 240693,
                    263343, 285989, 308563, 331033, 353350, 375494, 397447, 419210, 440795, 462224,
                    483532, 504758};
    ...
    public String toString() {
        return getYear() + "年" + (leap ? "闰" : "") + chineseNumber[month - 1] + "月"
    ...
    public Lunar nextMonthFirst(){
        ...
        return new Lunar(_year, _month, _day, _leap);
    }
    ...
    public static Date getSolarTermDate(int year, int solarTermIndex) {
        long ms =
                (long) (31556925974.7 * (year - 1900) + termInfo[solarTermIndex] * 60000)
                        + new DateTime(1900, 1, 6, 2, 5).getMillis();
        return new Date(ms);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getYear() == lunar.getYear() && getMonth() == lunar.getMonth()
                && getDay() == lunar.getDay() && isLeap() == lunar.isLeap();
    }
    ...
    public static void main(String[] args) {
        System.out.println(new Lunar(DateTimeUtils.parseDate("2014-10-24")));
        System.out.println(new Lunar(DateTimeUtils.parseDate("2014-10-24")).nextMonthFirst());
    }
}
