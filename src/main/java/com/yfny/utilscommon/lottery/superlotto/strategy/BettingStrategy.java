package com.yfny.utilscommon.lottery.superlotto.strategy;
...
public class BettingStrategy {
    ...
    public boolean applyStrategy(int[] nums) {
        return notUpperHalves(4, nums) || notLowerHalves(1, nums) || notConsecutive(nums)
                || notAllOdd(1, nums) || notAllEven(1, nums) || spanRange(15, 34, nums);
    }
