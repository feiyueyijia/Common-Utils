 ...
 **/
public class TestApplicationTask extends AbstractTask {

    public TestApplicationTask(int type) {
        super(type);
    }
    ...
    public void run() throws IOException, TemplateException {
        ...
        String filePath = FileUtil.getTestPath(projectName, type) + StringUtil.package2Path(basePackageName);
        String fileName = projectName + "ApplicationTests.java";
        // 生成Application文件
        System.out.println("Generating " + fileName);
        FileUtil.generateToJava(FrameFreemarkerConfigUtils.TYPE_TEST_APPLICATION, dataMap, filePath + fileName);
    }
}
